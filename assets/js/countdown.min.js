...
var _module,
  ...
  function d(a, b, c, e, d) {
    ...
    var k = null;
    "function" === typeof a ? (f = a, a = null) : a instanceof Date || (null !== a && isFinite(a) ? a = new Date(+a) : ("object" === _typeof(k) && (k = a), a = null));
    var g = null;
    "function" === typeof b ? (f = b, b = null) : b instanceof Date || (null !== b && isFinite(b) ? b = new Date(+b) : ("object" === _typeof(b) && (g = b), b = null));
    k && (a = x(k, b));
    g && (b = x(g, a));
    if (!a && !b) return new n();
